...
"""Verify that starting aprncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aprncoin with -h for help text")
        ...
        self.log.info("Start aprncoin with -version for version information")
        ...
        self.log.info("Start aprncoind with -fakearg to make sure it does not start")
