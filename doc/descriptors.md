# Support for Output Descriptors in aprncoin Core

Since aprncoin Core v0.17, there is support for Output Descriptors in the
...
on aprncoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing aprncoin Core wallets, a convenience function `combo` is
