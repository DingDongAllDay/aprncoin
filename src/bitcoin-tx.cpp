...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aprncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aprncoin-tx [options] <hex-tx> [commands]  Update hex-encoded aprncoin transaction\n" +
            "or:     aprncoin-tx [options] -create [commands]   Create hex-encoded aprncoin transaction\n" +
            "\n";
