...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("c13748170fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce60a1a0ff470612fe1b51580b4afc21b1794c5070ca70b9a3") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1552729812, 421231091, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("26ce50a7f4d3e1b192883ce47a13afc3d1b9b384a0532f1bdba63135fcf36a30"));
        assert(genesis.hashMerkleRoot == uint256S("638c9008c41df31c301af2b7327273a57ea43c2baff61302afd79c150e9a1cec"));
        ...
        // vSeeds.emplace_back("aprnets.com");
	...
	vSeeds.emplace_back("132.148.143.119");
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(0,28);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(0,28);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(0,28);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x83, 0x35, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x83, 0x88, 0xAD, 0xE4};
...
public:
	...
	vSeeds.emplace_back("132.148.143.119");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x83, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x83, 0x35, 0x83, 0x94};
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,58);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x83, 0x35, 0x04, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x87, 0x35, 0x04, 0x94};
